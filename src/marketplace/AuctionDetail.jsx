...
import {countDownRenderer, fetchCurrentPrice, truncateAddress} from "../utils/helpers";
...
const AuctionDetail = ({match, ...props}) => {
    ...
    return (
        <div className="max-w mx-auto">
            ...
            <div className="max-w-5xl mx-auto mt-12">
                <div
                    className="w-full mx-auto px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-8">
                    <div className="flex items-center space-x-5">
                        ...
                        <div>
                            <h1 className="text-xl text-gray-900 mb-0">{fetchCurrentPrice(auctionDetail)}</h1>
                ...
                <div
                    className="mt-8 w-full mx-auto px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-8"
                >
                            ...
                            <div className="bg-white shadow sm:rounded-lg">
                                <div className="px-4 py-5 sm:px-6">
                                    ...
                                    <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                        Sold by <span
                                        className="text-gray-900">{auctionDetail?.creator && truncateAddress(auctionDetail?.creator)}</span>
                                    </p>
                                </div>
                                    ...
                                    <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                                        <div className="sm:col-span-1">
                                            ...
                                            <dd className="mt-4 text-sm text-gray-900">
                                                <a
                                                    href=""
                                                    onClick={() => props.history.push(`/merchant/${auctionDetail?.creator}`)}
                                        ...
                                        <div className="sm:col-span-1">
                                            ...
                                            <dd className="mt-4 text-sm text-gray-900">
                                                <a
                                                    href=""
                                                    onClick={() => window.open(`https://kovan.etherscan.io/tx/${auctionDetail?.creationHash}`)}
                                                    className="text-gray-900 flex items-center underline"
                                                >
                                        ...
                                        <div className="sm:col-span-1">
                                            ...
                                            <dd className="mt-4 text-sm text-gray-900">
                                                ...
                                                {auctionDetail?.settlementHash && truncateAddress(auctionDetail?.settlementHash)}
                                            </dd>
                                        </div>
                                        ...
                                        <div className="sm:col-span-2">
                                            ...
                                            <dd className="mt-4 text-sm text-gray-900">
                                                {itemInfo?.markdownHash && (
                                                    <MarkdownViewer markdownHash={itemInfo?.markdownHash}/>
                                                )}
                                                        ...
                                                        >
                                                            <div className="w-0 flex-1 flex items-center">
                                                                <PaperClipIcon
                                                                    ...
                                                                    aria-hidden="true"/>
                                                                <span
                                                                    className="ml-2 flex-1 w-0 truncate">{truncateAddress(attachment)}</span>
                                                            </div>
                                                            <div className="ml-4 flex-shrink-0">
                                                                <a onClick={() => window.open(`https://ipfs.trofi.one/ipfs/${attachment}`)}
